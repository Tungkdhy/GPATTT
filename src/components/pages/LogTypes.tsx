...
export function LogTypes() {
  ...
  const [formData, setFormData] = useState<any>({
    ...
    value: '',
    description: '',
    category_type_id: '79bf9a36-49a8-4ae2-8377-5beb61665a42'
  });
  ...
  const {
    ...
    (page, limit) => categoryService.getAllFormat(page, limit, {scope:"LOG_CLASSIFICATION"}),
    [reload],
    { pageSize: 10, initialPage: 1 },
    {scope:"LOG_CLASSIFICATION"}
  );
...
// 79bf9a36-49a8-4ae2-8377-5beb61665a42
  // Edit
